...
void calcularFFT(short *muestras){
    ...
    obtenerNota(Reales,Imaginarias);
}
...
void obtenerNota(short *Xre,short *Xim){
    ...
    //Nota: do,
    aux1=(int)((float)f_do[0]*duracion);
    aux2=(int)((float)f_do[1]*duracion);
    aux3=(int)((float)f_do[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un do");
        bandera=1;
    }
    //Nota: do#,
    aux1=(int)((float)f_doG[0]*duracion);
    aux2=(int)((float)f_doG[1]*duracion);
    aux3=(int)((float)f_doG[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un do#");
        bandera=1;
    }
    //Nota: re, 
    aux1=(int)((float)f_re[0]*duracion);
    aux2=(int)((float)f_re[1]*duracion);
    aux3=(int)((float)f_re[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un re");
        bandera=1;
    }
    //Nota: re#, 
    aux1=(int)((float)f_reG[0]*duracion);
    aux2=(int)((float)f_reG[1]*duracion);
    aux3=(int)((float)f_reG[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un re#");
        bandera=1;
    }
    //Nota: mi, 
    aux1=(int)((float)f_mi[0]*duracion);
    aux2=(int)((float)f_mi[1]*duracion);
    aux3=(int)((float)f_mi[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un mi");
        bandera=1;
    }
    //Nota: fa, 
    aux1=(int)((float)f_fa[0]*duracion);
    aux2=(int)((float)f_fa[1]*duracion);
    aux3=(int)((float)f_fa[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un fa");
        bandera=1;
    }
    //Nota: fa#, 
    aux1=(int)((float)f_faG[0]*duracion);
    aux2=(int)((float)f_faG[1]*duracion);
    aux3=(int)((float)f_faG[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un fa#");
        bandera=1;
    }
    //Nota: sol, 
    aux1=(int)((float)f_sol[0]*duracion);
    aux2=(int)((float)f_sol[1]*duracion);
    aux3=(int)((float)f_sol[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un sol");
        bandera=1;
    }
    //Nota: sol#, 
    aux1=(int)((float)f_solG[0]*duracion);
    aux2=(int)((float)f_solG[1]*duracion);
    aux3=(int)((float)f_solG[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un sol#");
        bandera=1;
    }
    //Nota: la, 
    aux1=(int)((float)f_la[0]*duracion);
    aux2=(int)((float)f_la[1]*duracion);
    aux3=(int)((float)f_la[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un la");
        bandera=1;
    }
    //Nota: la#, 
    aux1=(int)((float)f_laG[0]*duracion);
    aux2=(int)((float)f_laG[1]*duracion);
    aux3=(int)((float)f_laG[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un la#");
        bandera=1;
    }
    //Nota: si, 
    aux1=(int)((float)f_si[0]*duracion);
    aux2=(int)((float)f_si[1]*duracion);
    aux3=(int)((float)f_si[2]*duracion);
    if(Xre[aux1]>amp || Xre[aux2]>amp || Xre[aux3]>amp){
        puts("La nota corresponde a un si");
        bandera=1;
    }
    if(!bandera){
        puts("Ninguna nota detectada\n");
    }
}