...
<html>
    ...
    <body background="img/bg-registro3.jpeg" style="background-size: 1500px 2500px;">
        ...
        <form action="rePiot_ser" method="post">
            ...
            <div style="background-color: #CEE3F6; width: 50%; height: 22em; margin: auto;text-align:center;border-radius:5px;margin-top:8%;box-shadow:10px 10px 50px grey">
                ...
                <textarea class="text-container-retweet" id="message1" name="message1"  placeholder="Comparte un pensamiento" style="width: 32em;" required></textarea>   
                <input name="message2" id="idtwtorg" value="<%=usuarioOriginal%>: <%=contenido%>" type="submit" hidden>
                <button name="message2" id="message2" value="<%=usuarioOriginal%>: <%=contenido%>" type="submit" class="btn btn-info" style="margin-left:25em;margin-top:1em;" name="login"  value="Piolinazo">Repiolin   <span class="glyphicon glyphicon-retweet"></span></button>  
                </div>                       
            </div><br>
