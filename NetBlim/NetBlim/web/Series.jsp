<%-- 
    Document   : Series
    Created on : 06-dic-2016, 15:15:29
 	...
 	{ 
  	if (count!=11) {
   	out.println("<div width=132 height=202 class='col-sm-3'>"
           + " <div class='panel-body' color:#000000><a href='infoSerie.jsp?idSesion="+rs.getString("idPeli_serie")+"''><img src='img/Images/"+rs.getString("url_imagen")+"' class='img-responsive' alt='Image'></a></div>"
           + "</div>");
