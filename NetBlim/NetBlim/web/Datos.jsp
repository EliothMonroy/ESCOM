<%-- 
    Document   : Datos
    Created on : 2/12/2016, 03:25:15 PM
    Author     : 
--%>
    ...
    <body>
        ...
        <div class="container container-margin">
            <div class="page-header text-center">
                <h1>Escribe la información de tu tarjeta
             ...
             <div class="row">
                 ...
                 <div class="col-xs-6">
                     <form action="Registro" method="post" role="form">
                        ...
                        <button type="submit" value='finalTarjeta' name='formulario' class="btn btn-primary">Dale!</button>
                    </form>
                 </div>
                 <div class="col-xs-3"></div>
             </div>
