<%-- 
    Document   : direactor
    Created on : 06-dic-2016, 14:50:58
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
          <br><li class="active"><a href="#section1">Perfil</a></li></br>
        <br><li color='white'>Lista de Géneros</li></br>
        <li><a href="cf.jsp" >Ciencia Ficcion</a></li>
    ...
    <%
      ...
      if(rs!=null){
           ...
           out.println("<font color='white'><h2 align='center'>No se encontraron coincidencias</h2></font>"); 
