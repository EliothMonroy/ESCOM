...
public class cConexion {
    ...
    public cConexion(){
        Driver_BD="com.mysql.cj.jdbc.Driver";
        Url_BD="jdbc:mysql://localhost/redes2?useSSL=false&useLegacyDatetimeCode=false&serverTimezone=UTC";
        Usuario_BD="root";
        Contrasena_BD="#n0m3l00";
    }
    //Conexion a la BD
